...
n_years_later <- function(member_data, years) {
  ...
  for (i in 1:length(member)){
    member_data[[i]][[2]] <- member_data[[i]][[2]] + years
  }
  return(member_data)
}
...
# Write your code here
library(readr)
cute_cute <- read_csv("C:\\Users\\huang\\Rlads\\hw4\\week3Rclass.csv")
...
```{r}
# Write your code here
cute_cute$favorite_word <- ""
for (i in 1:length(cute_cute$q_self)){
...
#助教解如下
#cute_cute$favorite_word <- ifelse(cute_cute$q_self >= 70, "根本可愛動物區", "一代一代")
